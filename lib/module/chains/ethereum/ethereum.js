...
export class Ethereum extends Chain {
  ...
  async createTransaction(params) {
    ...
    transaction.gasLimit = gasLimit !== undefined ? ethers.hexlify(gasLimit) : ethers.hexlify('0x5208');
    transaction.maxFeePerGas = maxFeePerGas !== undefined ? ethers.hexlify(maxFeePerGas) : ethers.parseUnits('10', 'gwei');
