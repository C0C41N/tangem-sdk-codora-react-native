...
class Ethereum extends _index.Chain {
  ...
  async createTransaction(params) {
    ...
    transaction.gasLimit = gasLimit !== undefined ? _ethers.ethers.hexlify(gasLimit) : _ethers.ethers.hexlify('0x5208');
    transaction.maxFeePerGas = maxFeePerGas !== undefined ? _ethers.ethers.hexlify(maxFeePerGas) : _ethers.ethers.parseUnits('10', 'gwei');
