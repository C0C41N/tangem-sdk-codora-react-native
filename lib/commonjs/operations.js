...
function signMultiple(params) {
  ...
  return _nativeModule.TangemSdkCodoraReactNative.signMultiple(unsignedHexArr, pubKeyBase58Arr, accessCode, cardId, msgHeader, msgBody);
}
