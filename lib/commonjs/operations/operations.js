...
exports.getSolanaNonceAccount = getSolanaNonceAccount;
...
function getSolanaNonceAccount(params) {
  const {
    accessCode,
    cardId,
    msgBody,
  ...
  return (0, _withNativeResponse.withNativeResponse)(() => _nativeModule.NativeModule.getSolanaNonceAccount(accessCode, cardId, msgHeader, msgBody));
}
